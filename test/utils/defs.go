...
const (
	// KpmServiceModelName is KPM service model name
	KpmServiceModelName = "oran-e2sm-kpm"
	// KpmServiceModelVersion is the version of KPM SM
	KpmServiceModelVersion = "v2"
	...
	// AvgUEsMeasName is the measurement name of the average number of UEs
	AvgUEsMeasName = "RRC.Conn.Avg"
)
