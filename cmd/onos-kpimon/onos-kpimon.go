...
func main() {
	...
	ricActionID := flag.Int("ricActionID", 1, "RIC Action ID in E2 message")
	ricRequestorID := flag.Int("ricRequestorID", 1, "RIC Requestor ID in E2 message")
	ricInstanceID := flag.Int("ricInstanceID", 1, "RIC Instance ID in E2 message")
	ranFuncID := flag.Int("ranFuncID", 1, "RAN Function ID in E2 message")
