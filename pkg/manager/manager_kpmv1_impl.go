	...
	return &V1Manager{
		AbstractManager: &AbstractManager{
			...
			Sessions: SBSessions{
				...
				E2Session: ricapie2.NewE2Session(config.E2tEndpoint, config.E2SubEndpoint, config.RicActionID, 0,
					config.SMName, config.SMVersion, kpiMonMetricMap, kpiMonMetricMapMutex, cellIDMapForSub, cellIDMapMutex),
			},
			Ctrls: Controllers{
