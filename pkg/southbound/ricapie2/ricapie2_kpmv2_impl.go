...
func (s *V2E2Session) manageConnection(indChan chan indication.Indication, nodeID string) {
...
func (s *V2E2Session) createE2Subscription(indChan chan indication.Indication, nodeID string) error {
